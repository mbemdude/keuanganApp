...
function resetTransaksiKeuanganTable() {
    ...
    try {
        ...
        $_SESSION['hasil'] = true;
        $_SESSION['pesan'] = "Semua data transaksi keuangan berhasil dihapus.";
    } catch (Exception $e) {
...
resetTransaksiKeuanganTable();

header("Location: ?page=transaksi-keuangan");
exit();
?>
