...
function resetTagihanSiswaTable() {
    // Membuat koneksi ke database
    $database = new Database();
    $db = $database->getConnection();

    // Nama tabel yang akan direset
    $tableName = 'tagihan_siswa';
    ...
    try {
        ...
        $_SESSION['hasil'] = true;
        $_SESSION['pesan'] = "Semua data tagihan siswa berhasil dihapus dan auto-increment telah direset.";
    } catch (Exception $e) {
