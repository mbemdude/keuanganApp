          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <a href="#" onclick="confirmDelete('?page=hapus-semua-jenjang')" class="btn btn-danger">Hapus Semua Data <i class="bi bi-trash-fill"></i></a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="#" onclick="confirmDelete('?page=hapus-jenjang&id=<?php echo $row['id'] ?>')" class="btn btn-danger"><i class="bi bi-trash"></i></a>
                      </td>
                    </tr>
                    <?php } ?>
                  </tbody>
