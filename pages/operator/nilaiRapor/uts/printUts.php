...
$queryNilai = $db->prepare("
    SELECT mp.kategori, mp.mata_pelajaran AS mapel, nr.nilai_uts
    FROM nilai_rapor nr
...
<div class="container">
    <header>
        <div class="row align-items-center">
            ...
            <div class="col-10">
                ...
                <p>Raport Penilaian Tengah Semester</p>
    ...
    foreach ($nilaiList as $nilai) {
        ...
        // Ambil rata-rata nilai_uts siswa sekelas untuk mapel ini
        $queryRata = $db->prepare("
            SELECT SUM(nr.nilai_uts) / COUNT(DISTINCT s.id) AS rata_uts
            FROM nilai_rapor nr
        ...
        $rataKelas = round($rataRow['rata_uts'] ?? 0, 1);
        
        echo "<tr>
            <td>{$rataKelas}</td>
            <td>" . ucwords(terbilang($nilai['nilai_uts'])) . "</td>
