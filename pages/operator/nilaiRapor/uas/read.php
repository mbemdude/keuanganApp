    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <a href="?page=tambah-nilai-rapor-uas" class="btn btn-success">Tambah Nilai</a>
                <a href="?page=impor-nilai-rapor-uas" class="btn btn-info">Impor Nilai</a>
                <a href="#" onclick="confirmDelete('?page=hapus-semua-nilai-rapor-uas')" class="btn btn-danger">Reset Semua Nilai</a>
            </div>
            <div class="card-body">
                ...
                <table id="myTable" class="table table-bordered">
                    ...
                    <?php
                        $stmtIsi = $db->prepare("SELECT COUNT(DISTINCT mata_pelajaran_id) FROM nilai_rapor WHERE siswa_id = ? AND tahun_ajaran_id = ? AND semester = ? AND nilai_uas != '' AND nilai_uas IS NOT NULL");
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#" onclick="printUas(<?= $siswa['id'] ?>, <?= $tahunAjaranAktif ?>, <?= $semesterAktif ?>)" class="btn btn-info"><i class="bi bi-printer"></i></a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                    <?php endif; ?>
