                ...
                <table id="myTable" class="display table table-striped">
                  ...
                  <tbody>
                    <?php 
                      ...
                      $selectSql = "SELECT hpa.*, s.nama FROM hasil_perhitungan_ahp hpa JOIN siswa s ON hpa.siswa_id = s.id";
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="#" onclick="confirmDelete('?page=hapus-perhitungan-ahp&id=<?php echo $row['id'] ?>')" class="btn btn-danger"><i class="bi bi-trash"></i></a>
                      </td>
                    </tr>
                    <?php } ?>
                  </tbody>
